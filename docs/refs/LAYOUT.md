...
вариантами использования). Модель — `docs/refs/COMMUNICATION.md` → *Имитатор цели*.
...
- Скелет — `skeletons/stub/`; модель stub'а в системе —
  `docs/refs/COMMUNICATION.md` → *Имитатор цели*; применимость инвариантов —
