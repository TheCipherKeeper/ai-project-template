...
> Это раскладка **инстанцированного** сервис-репо (после копирования
> `skeletons/service/`). **Стартовые файлы** лежат в `skeletons/service/` этого
> репо методологии — копируются в новый сервис-репо.
>
...
> `docs/refs/SPEC.md`. Топология репозиториев — `docs/refs/TOPOLOGY.md`.
