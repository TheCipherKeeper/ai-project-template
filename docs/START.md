...
код, тесты и документацию, запускают детерминированную обязательную и независимую
проверки, сливают PR с успешными проверками и разворачивают коммит в тестовой среде.
