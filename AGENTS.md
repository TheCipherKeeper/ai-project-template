...
> которые **копируются** при инстанциации новых репо. Сами хаб/сервисы —
> отдельные репо; они не несут guide/refs, а ссылаются сюда. Этот репо — корень
> авторитета в edge-модели `методология → хаб → сервисы` (см.
