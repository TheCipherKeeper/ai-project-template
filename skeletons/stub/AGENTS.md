...
(standalone-программа: форма — контейнер / CLI / …; не брокер-клиент, без
presentation; при наличии поверхности — out-of-band-наблюдение collector'ом).
...
> вариантами использования. Модель — `<methodology-repo>/docs/refs/COMMUNICATION.md` → *Имитатор цели*.
>
