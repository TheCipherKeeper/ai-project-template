...
<!-- Где проходит граница доверия сервиса, что по какую сторону, гарантии,
     ...
     Здесь же — presentation-эндпоинты (HTTP/WS) для интерфейсов: путь, метод,
     версия, формат ответа. Интерфейсы зовут их (см.
     <methodology-repo>/docs/refs/COMMUNICATION.md → «Клиентский край»); гейт
     сверяет заявленные интерфейсом вызовы с этой таблицей. -->

- Presentation-эндпоинты:
